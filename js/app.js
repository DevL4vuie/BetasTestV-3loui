...
function showLimitWarning() {
  ...
  box.innerHTML = `<i class="fas fa-exclamation-triangle" style="margin-top:1px;flex-shrink:0;"></i><div><strong>Daily limit reached.</strong><br/>Max 3 inquiries per day. Call us at <strong>09655220714</strong>.</div>`;
...
function showSuccessState(name, orderId, remaining) {
  const remainingMsg = remaining > 0
    ...
    : `<p style="margin-top:10px;font-size:12px;color:var(--grey);">You've used all 3 inquiries today. Call us at <strong>09655220714</strong>.</p>`;
  document.getElementById('inquiryModalBody').innerHTML = `
  ...
  el.innerHTML = `
    <div class="track-result-card">
      ...
      <div class="track-result-body">
        ...
        <p style="font-size:12px;color:var(--grey);text-align:center;margin-top:6px;">Questions? Call <strong>09655220714</strong></p>
      </div>
    </div>`;
}
...
async function sendInquiryAutoReply(inq) {
  try {
    ...
    const address   = inq.orderType === 'delivery'
      ...
      : 'Pickup at store — Gene\'s Lechon House, Zone 4, Lower Bulua, CDO';
  ...
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
    ...
    <div style="padding:28px 32px;">
      ...
      <p style="color:#888;font-size:13px;text-align:center;line-height:1.6;">
        Questions? Call us at <strong>09655220714</strong> or 09655220714<br/>
...
const CHAT_RULES = [
  ...
  { match: ['event','catering','party','kaarawan','birthday','fiesta','wedding','reunion','bulk','malaki','marami'],
    reply: `🎊 We love catering events! Gene's Lechon is perfect for:\n\n• 🎂 Birthdays\n• 💒 Weddings\n• 🏠 Family reunions\n• 🎉 Fiestas & celebrations\n\nFor bulk orders and event catering, please call us directly at **09655220714** so we can give you the best quote!`,
...
const FALLBACK_REPLIES = [
  `I'm not sure about that, but I can help with ordering, prices, delivery, and store info! 🐷 Or call us at **09655220714**.`,
  `Hmm, I didn't quite get that! Try asking about our **menu**, **prices**, **delivery**, or **store hours**. 😊`,
  `For that question, it's best to call us directly at **09655220714** or message us on Facebook! 🐷`,
];
